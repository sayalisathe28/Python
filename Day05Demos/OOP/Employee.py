...
#Break till 12.20
"""Module file : Employee.py   this has OOP implementation"""
class Employee:
    """Overloading concept """
...
#---------------------------------------------------------------------------------       
"""
Current script Employee.py when executed as a current file execution...
It get's loaded as "__main__" module name
"""
